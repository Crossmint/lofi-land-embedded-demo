...
function CryptoPurchase({ count, setShowCongrats, setOrderIdentifier, setQuoteMessage }) {
    ...
    if (signer == null || !address || !["EVM", "ETH"].includes(walletConnector?.connectedChain || "")) {
        return <p className="mt-2 text-s">Connect your ETH(Testnet) wallet to proceed.</p>;
    }
